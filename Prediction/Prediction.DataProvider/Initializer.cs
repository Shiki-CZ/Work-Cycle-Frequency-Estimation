...
using Prediction.DataProvider.Repositories;
...
namespace Prediction.DataProvider
{
    public static class Initializer
    {
         ...
         *
         * ########## For first use ##########
         * 1. Set path in CustomDbContext > OnComfiguration where you want create db (prefer path to project as : C\\path\\to\\project\\databaseFile.db)
        ...
        {
            services.AddScoped<IVoxelRepository, VoxelRepository>();
            services.AddScoped<IExtremeRepository, ExtremeRepository>();
            return services;
        }
    }
}
